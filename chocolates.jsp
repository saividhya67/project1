...
<%
    ...
    chocolatesDao chocolatesDao = new chocolatesDao(con);
    
    // Retrieve all products from the database
    List<chocolates> productList = chocolatesDao.getAllProducts();
%>
<!DOCTYPE html>
<html>
<head>
<%@include file="/includes/head.jsp"%>
<title>All gifts-Chocolates</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="breadcrumb">
        <a href="Home.html">Home</a> > <a href="chocolates.jsp">Chocolates</a> 
    </div>
    ...
    <div class="product-grid">
        <%
            for (chocolates product : productList) {
        %>
