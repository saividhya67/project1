...
<%
    ...
    // Create a SoftDao instance
    KidsDao KidsDao = new KidsDao(con);
    
    // Retrieve all products from the database
    List<Kids> productList = KidsDao.getAllProducts();
%>
<!DOCTYPE html>
<html>
<head>
<%@include file="/includes/head.jsp"%>
<title>All gifts-Kids</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="breadcrumb">
        <a href="Home.html">Home</a> > <a href="Kids.jsp">For Kids</a> 
    </div>
