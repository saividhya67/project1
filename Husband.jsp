...
<%
    ...
    HusbandDao husbandDao = new HusbandDao(con);
    
    // Retrieve all products from the database
    List<Husband> productList = husbandDao.getAllProducts();
%>
<!DOCTYPE html>
<html>
<head>
<%@include file="/includes/head.jsp"%>
<title>All gifts-Hasband</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="breadcrumb">
        <a href="Home.html">Home</a> > <a href="Husband.jsp">For Husband</a> 
    </div>
    ...
    <div class="product-grid">
        <%
            for (Husband product : productList) {
        %>
