...
<%
    ...
    // Create a HampersDao instance
    HampersDao softtoyDao = new HampersDao(con);
    
    // Retrieve all products from the database
    List<Hampers> productList = softtoyDao.getAllProducts();
%>
<!DOCTYPE html>
<html>
<head>
<%@include file="/includes/head.jsp"%>
<title>All gifts-Hampers</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="breadcrumb">
        <a href="Home.html">Home</a> > <a href="Hampers.jsp">Hampers</a> 
    </div>
    ...
    <div class="product-grid">
        <%
            for (Hampers product : productList) {
        %>
