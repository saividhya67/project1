...
<%
    ...
    DecorDao softtoyDao = new DecorDao(con);
    
    // Retrieve all products from the database
    List<Decor> productList = softtoyDao.getAllProducts();
%>
<!DOCTYPE html>
<html>
<head>
<%@include file="/includes/head.jsp"%>
<title>All gifts-Candles</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="breadcrumb">
        <a href="Home.html">Home</a> > <a href="Candles.html">Candles and Diffusers</a> 
    </div>
