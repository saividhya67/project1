...
<%
    ...
    SofttoyDao softtoyDao = new SofttoyDao(con);
    
    // Retrieve all products from the database
    List<Softtoy> productList = softtoyDao.getAllProducts();
%>
<!DOCTYPE html>
<html>
<head>
<%@include file="/includes/head.jsp"%>
<title>All gifts-Softtoy</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="breadcrumb">
        <a href="Home.html">Home</a> > <a href="softtoy.jsp">Soft Toys</a> 
    </div>
    ...
    <div class="product-grid">
        <%
            for (Softtoy product : productList) {
        %>
